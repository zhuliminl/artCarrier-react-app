/*
 * Copied by Saul at 2018/05/23
 *
 *  感谢这位老兄： https://github.com/MiLeung/top-bar-nav
 *
 */
...
export default class TopBarNav extends React.Component {
  static propTypes = {
    routeStack: PropTypes.arrayOf(
      PropTypes.shape({
        // 要求传入数组 
        // [{ label: 'string ro number' },{ label: 'string ro number' },{ label: 'string ro number' },]
