      ...
      <View>
        ...
        <View style={styles.orderItemHeaderContainer}>
          ...
          <View style={styles.orderStatusContainer}>
            <Text style={styles.orderStatusText}>等待发货</Text>
          </View>
        </View>
        {/* 订单商品列表 */}
        {
        ...
        <Text style={styles.orderTotalInfoContainer} >
          ...
          <Text style={styles.orderTotalInfoText}>{totalPrice}</Text>
        </Text>
      </View>
    )
  }
...
class UnDeliveryOrder extends React.Component {
  state = {
    routerPath: '/order?status=2',
    requestParams: null,
  }
...
export default UnDeliveryOrder;
