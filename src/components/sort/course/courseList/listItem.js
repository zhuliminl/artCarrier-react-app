...
class ListItem extends React.Component {
  render() {
    ...
    // const courseImageURL = course['img'] || '';
    ...
    // console.log('=====>>>>>课程图片', courseImageURL);
    return (
      <TouchableOpacity
      ...
      >
        ...
        {/* 价格和章节 */}
          <View style={ styles.coursePriceWithButtonContainer }>
            ...
            <TouchableWithoutFeedback style={ styles. buttonPurchaseContainer }>
              <TouchableOpacity
                onPress={() => {
                  console.log('加入购物车')
                }}>
                <Text style={ styles. buttonnPurchaseText }>立即购买</Text>
              </TouchableOpacity>
            </TouchableWithoutFeedback>
